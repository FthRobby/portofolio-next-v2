...
<template>
  <Card class="group hover:bg-white/[2%] hover:backdrop-blur-3xl shadow-sm transition-all duration-700 overflow-hidden">
    <NuxtLink :to="{ name: 'projects-slug', params: { slug: project.slug } }" class="grid grid-cols-2">
      <div>
        <CardHeader class="p-9 pb-4">
          ...
          <div class="w-full flex items-start justify-between gap-8">
            <p class="font-medium text-4xl font-display transition" :style="{ wordBreak: 'break-word' }">
