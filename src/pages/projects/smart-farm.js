...
import proj1 from "/public/images/projects/smartFarm.png";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Smartfarm dashboard." />
      </Head>
      <TransitionEffect />
      <main
        ...
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            >
              ...
              <p className="">
                Just like the Smart-Ternak dashboard, the SmartFarm Dashboard is
                also used for recording and monitoring the condition of
                livestock, but in this case, the livestock being monitored are
                goats. This dashboard includes a feature for recording when it
                is time to harvest goat's milk. The technologies used to create
                this dashboard include VueJS, Bootstrap, Vuex, and Axios for API
                communication.
              </p>
